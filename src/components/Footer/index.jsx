    ...
    <Container>
      <div className={style.container}>
          ...
          <ul className={style.categoryList}>
            {list.map((item) => (
              <li key={item.link} className={style.categoryItem}>
                ...
                <ul className={style.categorySyblist}>
        ...
        <div className={style.social}>
          <h2 className={classNames(style.title, style.socailTitle)}>
            Связаться с нами
          </h2>
        ...
        <div className={style.development}>
          <ul className={style.developmentList}>
            <li className={style.developmentItem}>
              Designer:
              <a href="https://t.me/Mrsmallowww" className={style.link}>
                Anastasia Ilina
              </a>
            </li>
            <li className={style.developmentItem}>
              Developer:
              <a href="https://t.me/gubarew_v" className={style.link}>
                Viktar Hubarevich
              </a>
            </li>
          </ul>
